...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "flex space-x-10 min-h-screen justify-center items-center bg-blue-500"
    },
    [
      _c("div", [
        _c(
          ...
          [
            ...
            _c(
              ...
              {
                staticClass:
                  "bg-green-500 font-extrabold text-3xl font-mono rounded-full p-2 text-center block w-full mt-2",
                attrs: { type: "submit" }
              },
      ...
      _c(
        ...
        _vm._l(_vm.messages, function(message, index) {
          return _c(
            "div",
            { key: index, staticClass: "bg-gray-100 p-2 mb-1 rounded shadow" },
            [_vm._v("\n            " + _vm._s(message.text) + "\n        ")]
          )
        }),
        0
...
var map = {
	...
	"./Hello": "./resources/js/Pages/Hello.vue",
	"./Hello.vue": "./resources/js/Pages/Hello.vue"
};
